...
exports.leaveFromWorkspace = void 0;
const WorkSpace_1 = require("../../models/WorkSpace");
const Users_1 = require("../../models/Users");
const leaveFromWorkspace = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        yield WorkSpace_1.WorkSpaceModel.updateOne({ _id: idWorkspace }, { $pull: { members: userId._id } });
...
exports.leaveFromWorkspace = leaveFromWorkspace;
