      ...
      <div className='w-full'>
        {messages.map((data) => (
          <div key={generateId()} className='flex gap-x-4'>
            <img src="https://flowbite.com/docs/images/people/profile-picture-5.jpg" className='w-16 h-16' alt="" />
            <div className='flex flex-col gap-y-4'>
              <span className='font-semibold text-xl text-[#555454]/80'>Nombre usuario</span>
